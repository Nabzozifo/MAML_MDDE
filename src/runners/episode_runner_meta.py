...
class EpisodeRunnerMeta:
    ...
    def __init__(self, args, logger):
        ...
        # self.sampler = Sampler(args.num_tasks)
        self.t = 0
    ...
    def setup(self, scheme, groups, preprocess, mac):
        self.new_batch = partial(EpisodeBatch, scheme, groups, self.batch_size, 500,
    ...
    def set_task(self, task, env):
        self.task = task
        env.episode_limit = self.task['max_episode_steps']
        self.episode_limit = env.episode_limit

    def run(self, env, test_mode=False):
        self.reset(env)
