...
if __name__ == '__main__':
    ...
    with open(os.path.join(os.path.dirname(__file__), "config", "default_meta.yaml"), "r") as f:
        try:
            config_dict = yaml.load(f)
        except yaml.YAMLError as exc:
            assert False, "default_meta.yaml error: {}".format(exc)
